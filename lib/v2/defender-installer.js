...
function install() {
    return __awaiter(this, arguments, void 0, function* (cliVersion = 'latest') {
...
function downloadDefenderCli(packagesDirectory, fileName, cliVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield verifyIntegrity(filePath, downloadUrl);
...
function verifyIntegrity(filePath, downloadUrl) {
    return __awaiter(this, void 0, void 0, function* () {
        const checksumUrl = `${downloadUrl}.sha256`;
        const expectedHash = yield downloadString(checksumUrl);
